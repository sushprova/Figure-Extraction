...
def highlight_word(img, word_to_find):
    ...
    for i in range(n_boxes):
        if int(data['conf'][i]) > 60:  # Confidence threshold
            if word_to_find.lower() in data['text'][i].lower():
                ...
                cv2.putText(img, word_to_find, (x, y - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.9, (36, 255, 12), 2)
...
def main():
    ...
    # highlight_word(imageForFigure, "Fig")
